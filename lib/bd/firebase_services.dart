...
Future<void> addProduct (String name, int price, String presentation, String imageUrl) async {
...
Future<void> updateProduct(String uid, String newName, int newPrice, String newPresentation, String newImageUrl) async {
