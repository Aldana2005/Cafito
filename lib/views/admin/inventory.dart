                  ...
                  confirmDismiss: (direction) async {
                    return await showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Text('¿Estás seguro de que deseas eliminar este producto: ${product['name']}?'),
                          actions: <Widget>[
                            TextButton(
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('Cantidad: ${productData['cantidad']}'), // Asegúrate de que el campo sea 'cantidad' en inventoryProducts
                        trailing: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () async {
                              setState(() {
                                currentQuantity = productData['cantidad']; // Actualizar la cantidad actual con la cantidad del producto
                              });

                              // Obtener la referencia al documento en "inventories"
                              DocumentReference inventoryDocRef = FirebaseFirestore.instance.collection('inventories').doc(inventoryProducts[index].id);

                              // Incrementar la cantidad en el mismo documento de "inventories"
                              await inventoryDocRef.update({'cantidad': FieldValue.increment(1)});
                               setState(() {
                          ...
                          IconButton(
                            onPressed: () async {
                              ...
                              if (currentQuantity > 0) {
                                ...
                                if (currentQuantity == 0) {
                                  await inventoryDocRef.delete(); // Eliminar el documento del inventario
                                }
                              }
                            },
                            icon: const Tooltip(
